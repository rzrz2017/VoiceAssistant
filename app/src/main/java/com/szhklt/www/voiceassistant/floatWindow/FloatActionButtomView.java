...
import com.szhklt.www.voiceassistant.view.FloatingActionButton;
import com.szhklt.www.voiceassistant.view.FloatingActionsMenu;
import com.szhklt.www.voiceassistant.view.FloatingActionsMenu.FabLayoutRanger;
...
public class FloatActionButtomView extends LinearLayout{
	...
	public FloatActionButtomView(Context context,FabLayoutRanger ranger) {
		super(context);
