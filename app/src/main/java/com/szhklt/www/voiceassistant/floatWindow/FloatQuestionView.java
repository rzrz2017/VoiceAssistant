...
public class FloatQuestionView extends View {
	...
	public FloatQuestionView(Context context,String cmd) {
		super(context);
		...
		//调整悬浮窗显示的停靠位置为左侧置顶  
		cParams.gravity = Gravity.CENTER_HORIZONTAL | Gravity.BOTTOM;         
		...
		//获取浮动窗口视图所在布局
		//类似setContentView()
		cmContentView = inflater.inflate(R.layout.bubble_question, null);

		//改变内容
		records = (TextView) cmContentView.findViewById(R.id.records);
		records.setText(cmd);
		//添加mFloatLayout  
