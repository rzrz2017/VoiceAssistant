...
public class AESUtil {
        ...
        private static String iv = "0000000000000000";//偏移量字符串必须是16位 当模式是CBC的时候必须设置偏移量
        ...
        public static String getEnc(String src, String keys){
        ...
        public static String getDec(String enc, String keys){

            try {
                byte key[] = keys.getBytes("utf-8");
                String dec = new String(decrypt(enc, key), "utf-8");
                return  dec;
            } catch (UnsupportedEncodingException e) {
                e.printStackTrace();
            } catch (Exception e) {
